...
#include "stm32l431xx.h"	// 目标芯片头文件，用户需要根据情况更改
...
#define TOS_CFG_EVENT_EN                0u		// TencentOS tiny 事件模块功能宏

#define TOS_CFG_MMBLK_EN                1u		//配置TencentOS tiny是否开启内存块管理模块

#define TOS_CFG_MMHEAP_EN               0u		//配置TencentOS tiny是否开启动态内存模块

#define TOS_CFG_MMHEAP_DEFAULT_POOL_EN  0u		// TencentOS tiny 默认动态内存池功能宏
...
#define TOS_CFG_SEM_EN                  0u		// 配置TencentOS tiny是否开启信号量模块
